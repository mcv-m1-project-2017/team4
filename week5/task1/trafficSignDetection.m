...
%                                   0->HSV seg+Morph.op.+CCL+TM
%                                   1-> Apply only watersheed and HSV
%                                   2-> Watersheed +Morphological
%                                   operators+CCL+TM
%                                   3-> 
%                                   4->
%
...
for i = 1:size(files,1)
    ...
    % Apply watersheed and HSV color segmentation to generate image mask
    if(method_num == 1||method_num == 2)
        [segmentationMask, windowCandidates] = watershed_hsvColourSegmentation(image, geometricFeatures, params);
